...
expect(sumDigits(""));
expect(sumDigits([42], [33]), undefined);
expect(sumDigits(23, 42), undefined);
expect(sumDigits("cosanguinité"), undefined);
expect(sumDigits(["creme", "brulée"]), undefined);
expect(sumDigits([3, 3, 5]), undefined);
